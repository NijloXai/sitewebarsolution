...
/* Helper pour obtenir les classes CSS d'animation selon l'index */
...
/* ============================================
   COMPOSANT MARCHÉS PUBLICS
   ============================================ */

export default function MarchesPublicsSection({
  avantages,
  documents,
  id = "marches-publics",
}: MarchesPublicsSectionProps) {
  return (
    <section
